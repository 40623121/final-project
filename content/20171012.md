Title: <span style="font-family:cursive;">2017 Fall CP 第五週</span>
...
<marquee direction="up"><font color=#FF3333 size=7 face=Comic Sans MS style=width:100%;filter:glow(color=#9900FF)>W5 PyQt5</font></marquee>

<!-- PELICAN_END_SUMMARY -->

###<b>上課內容:</b>

<font face="Microsoft JhengHei" color="	#FFA488" size="5">
推檔案過程:
leo存檔(Ctrl+S)☞推到遠端目錄☞點選github-blog☞<i><u>fossil add .</i></u>(or指定檔案位置)☞<i><u>fossil status</i></u>(檢查是否有missing的東西)☞有的話就<i><u>fossil delete</i></u>+位置刪除☞沒有就<i><u>fossil commit -m " "</i></u>(雙引號內的內容是顯示在倉儲Timeline的內容方便知道此次推送的大綱)
</font>

<font face="Microsoft JhengHei" color="	#888888" size="4">
以下為簡易程式碼
</font>
