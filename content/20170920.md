Title: <span style="font-family:cursive;">2017 Fall CP 第二週</span>
...
<marquee direction="left"><marquee scrollamount="30"><font color=#FFFF00 size=7 face=Arial style=width:100%;filter:glow(color=#AA0000)>本學期起各班透過一台 Ubuntu 16.04 主機, 建立 Fossil SCM 伺服器, 且每一學員發放一個 Fossil SCM 倉儲, 其中各學員可以利用 Wiki 與 Technote 紀錄學習資料外, 還可以將靜態網誌與簡報檔案放入 Files 資料區.</font></marquee></marquee>

<!-- PELICAN_END_SUMMARY -->

###<b>上課內容:</b>

<font face="Microsoft JhengHei" color="#AA7700" size="5"><i><u>cd </i></u> tmp(cd意思為進入某目錄)☞<i><u>mkdir </i></u> fossil(創建fossil目錄)☞<i><u>fossil clone</i></u>自己的遠端的.fossil檔(@前面+為綁定帳號，不加則純clone別人的.fossil檔)☞進入要解開.fossil檔的目錄☞<i><u>fossil open</i></u>(解開壓縮的.fossil檔內容)
</font>
